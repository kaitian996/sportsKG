<template>
    <main class="create-project">
        <el-dialog v-model="openDialog" :close-on-click-modal="true" :show-close="false" width="95%" top="40px">
            <!-- 头部 -->
            <template #header="{ close, titleId, titleClass }">
                <div class="step-warpper">
                    <div class="left-title">Create Project</div>
                    <div class="step-content">
                        <div @click="activeStepSet(0)" class="step-item" :class="activeStep === 0 ? 'item-active' : ''">
                            项目名称
                        </div>
                        <div @click="activeStepSet(1)" class="step-item" :class="activeStep === 1 ? 'item-active' : ''">
                            数据导入
                        </div>
                        <div @click="activeStepSet(2)" class="step-item" :class="activeStep === 2 ? 'item-active' : ''">
                            项目配置
                        </div>
                    </div>
            ...
            <div class="content-wapper">
                ...
                <div class="project-name" v-if="activeStep == 0">
                    <el-form :model="projectData" :rules="formRule" label-width="120px" label-position="top" size="large">
                        ...
                        <el-form-item label="项目描述" class="form-item">
                            <el-input placeholder="输入相关的项目描述" v-model="projectData.description" type="textarea" :rows="4" />
                        </el-form-item>
                    </el-form>
                </div>
                <!-- 数据导入 -->
                <div class="project-data" v-if="activeStep == 1">
                    ...
                    <!-- 已上传文件列表 -->
                    <div class="file-list">
                        <el-table :data="projectData.data" style="width: 100%" height="300">
                            ...
                            <div class="set-label-block">
                                ...
                                <div class="left-input">
                                    ...
                                    <div class="add-from-old">
                                        ...
                                        <el-select multiple collapse-tags collapse-tags-tooltip placeholder="从已有实体标签中选择"
                                            style="width: 240px" v-model="
                                                projectData.labelCategories
                                            " value-key="text">
                                            <el-option v-for="item in defaultLabelCategories" :key="item.text"
                            ...
                            <div class="set-label-block">
                                ...
                                <div class="left-input">
                                    ...
                                    <div class="add-from-old">
                                        ...
                                        <el-select multiple collapse-tags collapse-tags-tooltip placeholder="从已有实体关系中选择"
                                            style="width: 240px" v-model="
                                                projectData.connectionCategories
                                            " value-key="text">
                                            <el-option v-for="item in defaultConnectionCategories" :key="item.text"
                                                :label="item.text" :value="item" />
                                        </el-select>
                                    </div>
                                    <div class="add-from-new">
                            ...
                            <div class="view-data">
                                ...
                                <div class="data-list">
                                    <div class="label-list" v-if="areaIndex === 0">
                                        <el-table height="200" :data="projectData.onceLabels" style="width: 100%">
                                            ...
                                            <el-table-column label="实体内容" min-width="200">
                                                <template #default="scope">
                                                    {{
                                    ...
                                    <div class="connect-list" v-if="areaIndex === 1">
                                        <el-table height="200" :data="projectData.onceConnections" style="width: 100%">
                                            <el-table-column label="ID" min-width="100">
                                                <template #default="scope">
                                                    {{ scope.$index }}
                                                </template>
                                            </el-table-column>
                                            <el-table-column label="结束实体" min-width="100">
                                                <template #default="scope">
                                                    {{
                                                        computedAnnotationData.content.slice(
...
const addNewLabel = () => {
    ...
    if (isExisted !== -1) {
        ...
        projectData.labelCategories.push({
            text: trimEnter(newLabel.value), //fix:修复了用户输入时按了回车后导致的不正常显示bug
            color: "#757a79",
        })
    }
    newLabel.value = ""
...
const saveProject = () => {
    const nowDate = new Date()
    projectData.date = `${nowDate.getFullYear()}-${nowDate.getMonth() + 1
        }-${nowDate.getDate()} ${nowDate.getHours()}:${nowDate.getMinutes()}`
    if (!projectData.name) {
