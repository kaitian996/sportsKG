    ...
    <main class="chat-page">
        ...
        <section class="chat-content">
            ...
            <div class="chat-content-list">
                <div class="new-chat-box" @click="currentTheme = -1">
                    <el-icon>
                        <Plus />
                    </el-icon>
                    <div class="text">
                ...
                <div class="chat-history">
                    <div class="history-item" v-for="item, index in chatList" :key="item.theme"
            ...
            <div class="chat-content-box">
                <!-- 对话列表 -->
                <div class="chat-list">
                    <div class="chat-item" v-if="currentTheme !== -1" v-for="item in chatList[currentTheme].messages"
                        :class="`${item.role !== 'user' ? 'chat-ai' : 'chat-human'}`">
                        <div class="chat-item-content">
                            <!-- 左侧头像 -->
                            <div class="left-img">
                                <svg v-if="item.role === 'assistant'" width="25" height="25" viewBox="0 0 41 41" fill="none"
                                ...
                                <svg v-if="item.role === 'user'" t="1678875277985" class="icon" viewBox="0 0 1024 1024"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2796" width="25" height="25">
                                    <path
...
import { Plus, Promotion, ChatSquare, } from '@element-plus/icons-vue'
...
const sendMessage = async () => {
    if (currentTheme.value === -1) { //说明是新建主题
        ...
        chatList.value.push(newTheme)
        currentTheme.value = chatList.value.length - 1
    } else { //说明是新增对话
